...
docker run -d -p 127.0.0.1::143 --link dovecot:dovecot -e SERVER_HOSTNAME=dovecot -e FORCE_TLS=no -e CACHE_EXPIRATION_TIME=606 -e SYSLOG_PRIORITYMASK=LOG_DEBUG --name=imapproxy cheungpat/imapproxy
# webs

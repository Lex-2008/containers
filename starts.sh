...
docker run -d -v $PWD/squirrelmail.cont/data:/data -p 127.0.0.1:8001:80 --link dovecot:dovecot --link postfix:postfix --link baikal:baikal --name=squirrelmail squirrelmail
